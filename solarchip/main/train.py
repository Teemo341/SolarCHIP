...
from solarchip.utils import musa_support, nas_support # necessary for musa and nas support, otherwise will backend error
...
if __name__ == "__main__":
    ...
    try:
        ...
        if opt.use_wandb:
            trainer = Trainer(**trainer_config, logger=wandb_logger, callbacks=trainer_kwargs["callbacks"])
        else:
