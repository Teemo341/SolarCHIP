...
class SolarPredictorTests(unittest.TestCase):
    ...
    def test_flare_configs_share_training_and_monitoring_contracts(self) -> None:
        paths = (
            "configs/flare/solar_predictor_cnn.yaml",
            "configs/flare/solar_predictor_vit.yaml",
            "configs/flare/solar_predictor_cnn_full.yaml",
        )
    ...
    def test_checkpoint_rejects_changed_metric_class_ids(self) -> None:
        config = cnn_config()
